...
export async function getTokenPoolBalanceWithoutDecimals(
    mint: PublicKey,
    programId: PublicKey,
    connection: Connection
): Promise<number> {
...
export async function getTokenPoolBalanceWithDecimals(
    mint: PublicKey,
    programId: PublicKey,
    connection: Connection
): Promise<number> {
...
export async function getTokenBalanceWithoutDecimals(
    owner: PublicKey,
    mint: PublicKey,
    connection: Connection
): Promise<number> {
